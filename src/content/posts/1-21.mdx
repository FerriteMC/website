...
Stable Paper and Velocity 1.21 builds have been released!

<MandatoryBackups version="1.21" />
...
If you have previously contributed to our main Paper repository on GitHub and want the email or name that was used on that commit to be changed, you may use the modmail command on our Discord to tell us the new details. As per our planned [repository restructure in the future](https://github.com/orgs/FerriteMC/projects/6), the current git history will be overridden, so we thought we might as well fix the details for anyone that needs it.
