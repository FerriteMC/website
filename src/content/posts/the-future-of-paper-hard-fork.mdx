...
> While this may _sound_ scary, we have bundled up some helpful disclaimers for each relevant user group down below. We are committed to making this process as smooth as possible for everyone. If any more questions arise, feel free to ask us [on our Discord](https://discord.gg/ferritemc)!
...
It's hard to give an exact timeline, but you will be able to follow the rough progress of our hard fork process in the following GitHub issue: https://github.com/FerriteMC/Paper/issues/11735
...
**Forks/server hosts**: Migrate any use of the old version branches (e.g. `ver/1.8.8`, `ver/1.21.1`; everything below 1.21.4) to the [new archive repository](https://github.com/FerriteMC/Paper-archive).
