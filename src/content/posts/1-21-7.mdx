...
If you'd like to support FerriteMC as a whole, you can find more information at [ferritemc.io/sponsors](https://ferritemc.io/sponsors).

---

## Release Channel Changes

Among other changes — and the new V3 of our [Downloads API](https://docs.ferritemc.io/misc/downloads-api/) — release channels have changed to:
...
- [Compare changes](https://github.com/FerriteMC/Paper/compare/ab1b472c5663f4123632770db8ea509b9be49e20..11a1e0ffd25be0224c878ebaf629191863264861)
- [Pull Request #12671](https://github.com/FerriteMC/Paper/pull/12671)
...
- [Registry events](https://docs.ferritemc.io/paper/dev/registries/) for modifying or adding custom cat, chicken, cow, frog, pig, and wolf variants, as well as damage types and paintings
