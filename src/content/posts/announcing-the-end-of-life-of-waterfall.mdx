...
Migrate to [Velocity](https://ferritemc.io/software/relay)! All the knowledge the people who originally worked on Waterfall gained has been put into Velocity, a proxy solution that was built from the ground up with performance, stability and security in mind. You can learn how to get started with Velocity on our [documentation site](https://docs.ferritemc.io/velocity/getting-started).

You can find plugins compatible with Velocity on [Hangar, our new plugin repository](https://hangar.ferritemc.io/?page=0&platform=VELOCITY&sort=-stars).

If you encounter any issues while migrating to Velocity, feel free to post on the forums or our [Discord](https://discord.gg/ferritemc), we are happy to help!
