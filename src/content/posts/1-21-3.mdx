...
- You can now create custom painting art via API and the new `RegistryEvents.PAINTING_VARIANT`. More are coming over time as well - see https://docs.ferritemc.io/paper/dev/registries for more info on how to use them
